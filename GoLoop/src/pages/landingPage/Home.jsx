...
import img1 from "../../assets/img/goloop1.png"; // ganti sesuai nama file kamu
...
function Home() {
  return (
    <div className="font-quicksand">
      ...
      {/* Pembungkus ini menggunakan "items-center" untuk memosisikan semua elemen di dalamnya (termasuk gambar) ke tengah secara horizontal. */}
      <div className="w-full pt-12 h-[600px] px-6 bg-white flex flex-col items-center text-center">
        <h2 className="text-4xl font-bold mb-10" style={{ color: "#2C441E" }}>
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold pt-8 text-[#334222] mb-4">What We Do?</h2>
      ...
      <div className="grid grid-cols-1 px-24 md:grid-cols-3 gap-8">
        {/* Card 1 */}
        ...
        <div className="rounded-[40px] overflow-hidden shadow-lg bg-[#3E532D] text-white">
          ...
          <div className="p-6">
            ...
            <p className="text-sm">
              ...
              sampah lebih efektif dan ramah lingkungan
            </p>
          </div>
        </div>
        ...
        <div className="rounded-[40px] overflow-hidden shadow-lg bg-[#3E532D] text-white">
          ...
          <div className="p-6">
            ...
            <p className="text-sm">
              tingkatkan kesadaranmu terhadap sekitar jadikan tempat yang layak
              untuk kita tinggal
            </p>
          </div>
        </div>
